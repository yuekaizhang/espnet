...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-json', type=str,
                        help='data.json')
    parser.add_argument('--mode-subsample', type=str, required=True,
                        help='one of ("asr", "mt", "st")')
    parser.add_argument('--arch-subsample', type=str, required=True,
    ...
    #parser.add_argument('--etype',type=str,default=)
    ...
    #    min_io_ratio = 4
    #else:
    subsample = get_subsample(args, mode=args.mode_subsample, arch=args.arch_subsample)
